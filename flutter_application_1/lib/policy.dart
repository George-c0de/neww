...
class PagePolicy extends StatefulWidget {
  ...
  @override
  _PagePolicyState createState() => _PagePolicyState();
}

class _PagePolicyState extends State<PagePolicy> {
  var text;
  @override
  void initState() {
    super.initState();
      ...
      body: Container(
        child : ListView(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.symmetric(horizontal: 20,vertical: 40),child:Text('Правовые документы',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),)),
            Container(
