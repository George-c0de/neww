  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      child: Container(
        ...
        child: Column(
          children: [
            Container(width: 100,padding: EdgeInsets.only(left:5,right:5),child:Image.network(item['img'],fit: BoxFit.cover,),),
...
class _PriceDigitsState extends State<PriceDigits> with SingleTickerProviderStateMixin{
  ...
  Future<void> addtocart() async{
    ...
    var ur = baseurl+'addtocartdefaultapp/?device='+a+'&size='+size.toString()+'&id='+id.toString()+'&count='+count.toString()+'&price='+price.toString()+'&dops='+dopss;
      ...
      body: Container(
        child : ListView(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.only(left: 20, right: 20, bottom: 12),child: Text(item['weight'].toString() +' г',style: TextStyle(fontSize: 15,color:Color(0xff272727)),),),
            Padding(padding: EdgeInsets.only(left: 20, right: 20, bottom: 12),child: Text(item['description'],style: TextStyle(fontSize: 16,color:Color(0xff272727)),),), Column(
              ...
              Container(
                ...
                child:SingleChildScrollView(
                  ...
                  child: Wrap(
                    ...
                    runSpacing: 5,
                    children: [
                      for (var itemdop in item['dops']) DopItem(fo:addtolist,fo1:delfromList,item: {'title':itemdop['title'],'img':itemdop['img'],'price':itemdop['price']},activeit:false),
                    ]
                  )
                ),
              )
...
class ItemDefaultPage extends StatelessWidget {
  var item;
  ItemDefaultPage({ Key? key,required this.item}) : super(key: key); 
  @override
  Widget build(BuildContext context) {
